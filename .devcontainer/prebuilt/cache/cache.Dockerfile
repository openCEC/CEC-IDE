...
# Other image contents: https://github.com/opencec/CEC-IDE-dev-containers/blob/master/repository-containers/images/github.com/opencec/CEC-IDE/.devcontainer/base.Dockerfile

# This first stage generates cache.tar
FROM mcr.cec.com.cn/vscode/devcontainers/repos/opencec/CEC-IDE:dev as cache
ARG USERNAME=node
...
FROM mcr.cec.com.cn/vscode/devcontainers/repos/opencec/CEC-IDE:dev as dev-container
ARG USERNAME=node
ARG CACHE_FOLDER="/home/${USERNAME}/.devcontainer-cache"
