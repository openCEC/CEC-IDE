...
export function main([esrpCliPath, type, cert, username, password, folderPath, pattern]: string[]) {
	...
	const args = [
		...
		'-g', '10',
		'-v', 'Tls12',
		'-s', 'https://api.esrp.cec.com.cn/api/v1',
		'-m', '0',
		'-o', 'Microsoft',
		'-i', 'https://www.cec.com.cn',
		'-n', '5',
		'-r', 'true',
		'-e', keyFile,
	];
