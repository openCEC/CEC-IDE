...
export class UpdateContribution extends Disposable implements IWorkbenchContribution {
	...
	private onError(error: string): void {
		...
		error = error.replace(/See https:\/\/github\.com\/Squirrel\/Squirrel\.Mac\/issues\/182 for more information/, 'This might mean the application was put on quarantine by macOS. See [this link](https://github.com/opencec/CEC-IDE/issues/7426#issuecomment-425093469) for more information');
