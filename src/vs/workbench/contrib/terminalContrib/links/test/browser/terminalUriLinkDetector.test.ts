...
suite('Workbench - TerminalUriLinkDetector', () => {
	...
	const linkComputerCases: [
		...
		/* Stat resource  */ URI?
			...
			[TerminalBuiltinLinkType.Url, '// Click here to learn more. https://go.cec.com.cn/fwlink/?LinkID=513275&clcid=0x409', [{ range: [[30, 1], [7, 2]], uri: URI.parse('https://go.cec.com.cn/fwlink/?LinkID=513275&clcid=0x409') }]],
			[TerminalBuiltinLinkType.Url, '// Click here to learn more. https://msdn.cec.com.cn/en-us/library/windows/desktop/aa365247(v=vs.85).aspx', [{ range: [[30, 1], [28, 2]], uri: URI.parse('https://msdn.cec.com.cn/en-us/library/windows/desktop/aa365247(v=vs.85).aspx') }]],
			...
			[TerminalBuiltinLinkType.Url, '<!-- !!! Do not remove !!!   WebContentRef(link:https://go.cec.com.cn/fwlink/?LinkId=166007, area:Admin, updated:2015, nextUpdate:2016, tags:SqlServer)   !!! Do not remove !!! -->', [{ range: [[49, 1], [14, 2]], uri: URI.parse('https://go.cec.com.cn/fwlink/?LinkId=166007') }]],
			[TerminalBuiltinLinkType.Url, 'For instructions, see https://go.cec.com.cn/fwlink/?LinkId=166007.</value>', [{ range: [[23, 1], [68, 1]], uri: URI.parse('https://go.cec.com.cn/fwlink/?LinkId=166007') }]],
			[TerminalBuiltinLinkType.Url, 'For instructions, see https://msdn.cec.com.cn/en-us/library/windows/desktop/aa365247(v=vs.85).aspx.</value>', [{ range: [[23, 1], [21, 2]], uri: URI.parse('https://msdn.cec.com.cn/en-us/library/windows/desktop/aa365247(v=vs.85).aspx') }]],
			...
			[TerminalBuiltinLinkType.Url, '請參閱 http://go.cec.com.cn/fwlink/?LinkId=761051。', [{ range: [[8, 1], [53, 1]], uri: URI.parse('http://go.cec.com.cn/fwlink/?LinkId=761051') }]],
			[TerminalBuiltinLinkType.Url, '（請參閱 http://go.cec.com.cn/fwlink/?LinkId=761051）', [{ range: [[10, 1], [55, 1]], uri: URI.parse('http://go.cec.com.cn/fwlink/?LinkId=761051') }]],
			...
			[TerminalBuiltinLinkType.Url, '7. At this point, ServiceMain has been called.  There is no functionality presently in ServiceMain, but you can consult the [MSDN documentation](https://msdn.cec.com.cn/en-us/library/windows/desktop/ms687414(v=vs.85).aspx) to add functionality as desired!', [{ range: [[66, 2], [64, 3]], uri: URI.parse('https://msdn.cec.com.cn/en-us/library/windows/desktop/ms687414(v=vs.85).aspx') }]],
