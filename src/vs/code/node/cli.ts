...
export async function main(argv: string[]): Promise<any> {
	...
	// Write File
		...
		try {
			...
			if (isWindows) {
				...
				// (see https://github.com/opencec/CEC-IDE/issues/931) and
	...
	// Just Code
		...
		if (hasStdinWithoutTty()) {
			...
			// checking for stdin being connected to a TTY is not enough (https://github.com/opencec/CEC-IDE/issues/40351)
		...
		if (!isMacOSBigSurOrNewer) {
			...
			// https://github.com/opencec/CEC-IDE/issues/102975
			...
			for (const e in env) {
				...
				// https://github.com/opencec/CEC-IDE/issues/134696.
				if (e !== '_') {
					spawnArgs.push('--env');
