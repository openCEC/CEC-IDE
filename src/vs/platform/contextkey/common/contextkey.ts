...
/** allow register constant context keys that are known only after startup; requires running `substituteConstants` on the context key - https://github.com/opencec/CEC-IDE/issues/174218#issuecomment-1437972127 */
