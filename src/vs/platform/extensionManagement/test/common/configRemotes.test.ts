...
suite('Config Remotes', () => {
	...
	test('HTTPS remotes', function () {
		assert.deepStrictEqual(getDomainsOfRemotes(remote('https://github.com/opencec/CEC-IDE.git'), allowedDomains), ['github.com']);
	...
	test('SCP-like remotes', function () {
		assert.deepStrictEqual(getDomainsOfRemotes(remote('git@github.com:opencec/CEC-IDE.git'), allowedDomains), ['github.com']);
	...
	test('Multiple remotes', function () {
		const config = ['https://github.com/opencec/CEC-IDE.git', 'https://git.example.com/gitproject.git'].map(remote).join('');
	...
	test('Non allowed domains are anonymized', () => {
		const config = ['https://github.com/opencec/CEC-IDE.git', 'https://git.foobar.com/gitproject.git'].map(remote).join('');
	...
	test('HTTPS remotes to be hashed', function () {
		assert.deepStrictEqual(getRemotes(remote('https://github.com/opencec/CEC-IDE.git')), ['github.com/opencec/CEC-IDE.git']);
		...
		// Strip .git
		assert.deepStrictEqual(getRemotes(remote('https://github.com/opencec/CEC-IDE.git'), true), ['github.com/opencec/CEC-IDE']);
		...
		assert.deepStrictEqual(getRemotes(remote('https://github.com/opencec/CEC-IDE.git'), true), getRemotes(remote('https://github.com/opencec/CEC-IDE')));
	...
	test('SCP-like remotes to be hashed', function () {
		assert.deepStrictEqual(getRemotes(remote('git@github.com:opencec/CEC-IDE.git')), ['github.com/opencec/CEC-IDE.git']);
		...
		// Strip .git
		assert.deepStrictEqual(getRemotes(remote('git@github.com:opencec/CEC-IDE.git'), true), ['github.com/opencec/CEC-IDE']);
		...
		// Compare Striped .git with no .git
		assert.deepStrictEqual(getRemotes(remote('git@github.com:opencec/CEC-IDE.git'), true), getRemotes(remote('git@github.com:opencec/CEC-IDE')));
	...
	test('Multiple remotes to be hashed', function () {
		const config = ['https://github.com/opencec/CEC-IDE.git', 'https://git.example.com/gitproject.git'].map(remote).join(' ');
		assert.deepStrictEqual(getRemotes(config), ['github.com/opencec/CEC-IDE.git', 'git.example.com/gitproject.git']);

		// Strip .git
		assert.deepStrictEqual(getRemotes(config, true), ['github.com/opencec/CEC-IDE', 'git.example.com/gitproject']);

		// Compare Striped .git with no .git
		const noDotGitConfig = ['https://github.com/opencec/CEC-IDE', 'https://git.example.com/gitproject'].map(remote).join(' ');
