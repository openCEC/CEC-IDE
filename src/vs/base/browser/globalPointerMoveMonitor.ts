		...
		try {
			...
			this._hooks.add(toDisposable(() => {
				try {
					...
					// See https://github.com/opencec/CEC-IDE/issues/161731
					//
			...
			// See https://github.com/opencec/CEC-IDE/issues/144584
			// See https://github.com/opencec/CEC-IDE/issues/146947
