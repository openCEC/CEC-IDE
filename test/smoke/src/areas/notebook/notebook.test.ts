...
export function setup(logger: Logger) {
	describe.skip('Notebooks', () => { // https://github.com/opencec/CEC-IDE/issues/140575
		...
		it.skip('moves focus in and out of output', async function () { // TODO@rebornix https://github.com/opencec/CEC-IDE/issues/139270
			const app = this.app as Application;
			await app.workbench.notebook.openNotebook();
		...
		it.skip('cell action execution', async function () { // TODO@rebornix https://github.com/opencec/CEC-IDE/issues/139270
			const app = this.app as Application;
			await app.workbench.notebook.openNotebook();
			await app.workbench.notebook.insertNotebookCell('code');
