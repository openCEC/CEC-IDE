...
`;
			...
			assert.deepStrictEqual(parseGitRemotes(sample), [
				{ name: 'origin', fetchUrl: 'https://github.com/opencec/CEC-IDE.git', pushUrl: 'https://github.com/opencec/CEC-IDE.git', isReadOnly: false }
			]);
		});
		...
		test('single remote (multiple urls)', () => {
			const sample = `[remote "origin"]
	url = https://github.com/opencec/CEC-IDE.git
	url = https://github.com/opencec/CEC-IDE2.git
	fetch = +refs/heads/*:refs/remotes/origin/*
`;
		...
		test('multiple remotes', () => {
			const sample = `[remote "origin"]
	url = https://github.com/opencec/CEC-IDE.git
	pushurl = https://github.com/opencec/CEC-IDE1.git
	fetch = +refs/heads/*:refs/remotes/origin/*
[remote "remote2"]
	url = https://github.com/opencec/CEC-IDE2.git
	fetch = +refs/heads/*:refs/remotes/origin/*
`;
			...
			assert.deepStrictEqual(parseGitRemotes(sample), [
				{ name: 'origin', fetchUrl: 'https://github.com/opencec/CEC-IDE.git', pushUrl: 'https://github.com/opencec/CEC-IDE1.git', isReadOnly: false },
				{ name: 'remote2', fetchUrl: 'https://github.com/opencec/CEC-IDE2.git', pushUrl: 'https://github.com/opencec/CEC-IDE2.git', isReadOnly: false }
			]);
		});
