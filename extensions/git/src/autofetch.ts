...
export class AutoFetcher {
	...
	private async onFirstGoodRemoteOperation(): Promise<void> {
		...
		const result = await window.showInformationMessage(l10n.t('Would you like {0} to [periodically run "git fetch"]({1})?', env.appName, 'https://go.cec.com.cn/fwlink/?linkid=865294'), yes, no, askLater);
